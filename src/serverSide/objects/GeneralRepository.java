...
public class GeneralRepository implements GeneralRepositoryInterface {
  ...
  /**
   * Assault party # (# - 1, (M-1)/K) elem # (# - 1 .. K) room identification
   * (1 .. N).
   */
  private int[] assaultPartyRoomId;

  /**
   * Assault party # (# - 1, (M-1)/K) elem # (# - 1 .. K) member identification
   * (1 .. N).
   */
  private int[][] assaultPartyElementId;

  /**
   * Assault party # (# - 1, (M-1)/K) elem # (# - 1 .. K) present position
   * (0 .. DT RId).
   */
  ...
  /**
   * Write the header and first state line to the logging file.
   * Internal operation.
   */
