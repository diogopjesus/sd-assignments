...
public class ServerHeistToTheMuseumGeneralRepository {
     ...
     * Main method.
     *
     * @param args runtime arguments args[0] - port number for listening to service requests
     */
    public static void main(String[] args) {
        ...
        reposInter = new GeneralRepositoryInterface(repos); // interface to the service is
                                                            // instantiated
        ...
        while (waitConnection) {
            try {
                ...
                cliProxy = new GeneralRepositoryClientProxy(sconi, reposInter); // start a service
                                                                                // provider agent to
                                                                                // address
