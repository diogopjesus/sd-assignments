...
/**
 * Server side of the Control Collection Site.
 *
...
public class ServerHeistToTheMuseumControlCollectionSite {
    ...
    public static void main(String[] args) {
        ControlCollectionSite contColSite; // ControlCollectionSite (service to be rendered)
        ControlCollectionSiteInterface contColSiteInter; // interface to the control collection site
        ...
        contColSite = new ControlCollectionSite(reposStub, assPartStub);
        // interface to the service is instantiated
        contColSiteInter = new ControlCollectionSiteInterface(contColSite);
        ...
        while (waitConnection) {
            try {
                ...
                cliProxy = new ControlCollectionSiteClientProxy(sconi, contColSiteInter);
