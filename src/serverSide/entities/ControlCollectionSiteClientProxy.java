 ...
 */
public class ControlCollectionSiteClientProxy extends Thread
     ...
     */
    private ControlCollectionSiteInterface contColSiteInter;
     ...
     */
    public ControlCollectionSiteClientProxy(ServerCom sconi,
            ControlCollectionSiteInterface contColSiteInter) {
        super("ControlCollectionSiteProxy_" + ControlCollectionSiteClientProxy.getProxyId());
        this.sconi = sconi;
        this.contColSiteInter = contColSiteInter;
    }
    ...
    public void run() {
        ...
        try {
            outMessage = contColSiteInter.processAndReply(inMessage); // process it
