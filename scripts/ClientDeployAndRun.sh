...
sshpass -f password ssh $LOGIN@$NODE07 'cd test/HeistToTheMuseum/dirClient ; java clientSide.main.ClientHeistToTheMuseum $NODE01 $PORT2 $NODE02 $PORT2 $NODE03 $PORT2 $NODE04 $PORT2 $NODE05 $PORT2 $NODE06 $PORT2'
