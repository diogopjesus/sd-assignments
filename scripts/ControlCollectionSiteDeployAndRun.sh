...
sshpass -f password ssh $LOGIN@$NODE04 "cd test/HeistToTheMuseum/dirControlCollectionSite ; java serverSide.main.ServerHeistToTheMuseumControlCollectionSite $PORT2 $NODE06 $PORT2 $NODE01 $PORT2 $NODE02 $PORT2"
