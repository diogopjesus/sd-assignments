...
sshpass -f password ssh $LOGIN@$NODE04 'cd test/HeistToTheMuseum/dirControlCollectionSite ; java serverSide.main.ServerHeistToTheMuseumControlCollectionSite $PORT2'
